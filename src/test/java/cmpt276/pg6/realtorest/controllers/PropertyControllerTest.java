...
public class PropertyControllerTest {
    ...
    @Test
    void getProperties_NoParams_ShouldReturnAllProperties() throws Exception {
        // Setup mock behavior
    ...
    //  test: Admin access to edit listing, Should Return EditPage
    @Test
    void Admin_editListing() throws Exception {
    ...
    @Test
    public void addProperty_ShouldSavePropertyAndRedirect() throws Exception {
    ...
    @Test
void showDevPageProperties() throws Exception {
...
@Test
void showDevEditProperty() throws Exception {
...
@Test
void fillTestingDataProperties() throws Exception {
    String redirectUrl = "/properties";
...
@Test
void deleteAllProperties_ShouldDeleteAllAndRedirect() throws Exception {
    String redirectUrl = "/properties";
